...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private TextView bannerTitle, numIndicatorInside, numIndicator, icNumIndicator, icIndicatorTitle;
    private LinearLayout indicator, indicatorInside, titleView;
    private RelativeLayout indicatorIc;
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        indicatorIc = (RelativeLayout) view.findViewById(R.id.li_ic_indicator_);
        ...
        icNumIndicator = (TextView) view.findViewById(R.id.ic_numIndicator);
        icIndicatorTitle = (TextView) view.findViewById(R.id.ic_indicator_title);
    ...
    private void setBannerStyleUI() {
        ...
        switch (bannerStyle) {
            ...
            case BannerConfig.CIRCLE_INDICATOR_TITLE_INSIDE:
                ...
                setTitleStyleUI();
                break;
            case BannerConfig.ICON_NUM_INDICATOR_TITLE://拥有数字、标题、icon
                indicatorIc.setVisibility(visibility);
                indicatorIc.setBackground(getResources().getDrawable(R.color.banner_color_gray));
                icIndicatorTitle.setText(titles.get(0));
//                setTitleStyleUI();
                break;
        }
    }
    ...
    private void initImages() {
        ...
        } else if (bannerStyle == BannerConfig.ICON_NUM_INDICATOR_TITLE) {
            //自定义的：数字指示器、图标
            icNumIndicator.setText("1/" + count);
        }
    }
    ...
    public void onPageSelected(int position) {
        ...
        switch (bannerStyle) {
            ...
            case BannerConfig.NUM_INDICATOR:
                ...
                break;
            case BannerConfig.NUM_INDICATOR_TITLE://显示指示器和标题
            ...
            case BannerConfig.CIRCLE_INDICATOR_TITLE_INSIDE:
                bannerTitle.setText(titles.get(position - 1));
                break;
            case BannerConfig.ICON_NUM_INDICATOR_TITLE://显示数字指示器和标题
                //自定义的：数字指示器、图标
                indicator.setVisibility(View.GONE);
                bannerTitle.setVisibility(View.GONE);
                icNumIndicator.setText(position + "/" + count);
                icIndicatorTitle.setText(titles.get(position - 1));
                break;
        }
